...
export default function AcademicYearsList({ years, loading }: AcademicYearsListProps) {
  ...
  return (
    <>
      ...
      {/* Desktop grid layout */}
      <div className="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 pb-6">
        {academicYears.map((year, index) => (
          <motion.div 
            key={year.id}
            initial={{ opacity: 0, y: 20 }}
