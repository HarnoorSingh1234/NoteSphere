...
const YearsCard = () => {
  return (
    <div className="h-full bg-white border-[0.25em] sm:border-[0.3em] md:border-[0.35em] border-[#264143] rounded-[0.4em] sm:rounded-[0.5em] md:rounded-[0.6em] shadow-[0.3em_0.3em_0_#E99F4C] sm:shadow-[0.35em_0.35em_0_#E99F4C] md:shadow-[0.4em_0.4em_0_#E99F4C] overflow-hidden group hover:translate-y-[-0.2em] sm:hover:translate-y-[-0.25em] md:hover:translate-y-[-0.3em] hover:shadow-[0.35em_0.35em_0_#E99F4C] sm:hover:shadow-[0.4em_0.4em_0_#E99F4C] md:hover:shadow-[0.5em_0.5em_0_#E99F4C] transition-all duration-300 relative flex flex-col">
      ...
      {/* Colored header */}
      <div className="bg-[#DE5499] py-3 sm:py-4 md:py-5 px-4 sm:px-5 md:px-6 relative">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 relative z-10">
          <div className="flex items-center justify-center transition-all duration-200 ease-in-out hover:rotate-[-5deg] hover:scale-105 w-[2rem] sm:w-[2.25rem] md:w-[2.5rem] h-[2rem] sm:h-[2.25rem] md:h-[2.5rem] bg-white border-[0.15em] sm:border-[0.17em] md:border-[0.2em] border-[#264143] rounded-[0.3em] sm:rounded-[0.35em] md:rounded-[0.4em] shadow-[0.15em_0.15em_0_#E99F4C] sm:shadow-[0.17em_0.17em_0_#E99F4C] md:shadow-[0.2em_0.2em_0_#E99F4C]">
            <BookOpen className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5 text-[#264143]" />
          </div>
          <h2 className="text-xl sm:text-xl md:text-2xl font-bold text-white">Academic Years</h2>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-grow">
        ...
        <div className="space-y-3 sm:space-y-3.5 md:space-y-4 mb-4 sm:mb-5 md:mb-6">
          <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3">
            <div className="w-7 h-7 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full transition-all duration-200 ease-in-out hover:rotate-[-5deg] hover:scale-105 bg-[#EDDCD9] flex items-center justify-center flex-shrink-0">
              <Layers className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#264143]" />
            </div>
            <span className="text-sm sm:text-sm md:text-base text-[#264143]">Organized study materials</span>
          </div>
          
          <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3">
            <div className="w-7 h-7 sm:w-7 sm:h-7 md:w-8 transition-all duration-200 ease-in-out hover:rotate-[-5deg] hover:scale-105 md:h-8 rounded-full bg-[#EDDCD9] flex items-center justify-center flex-shrink-0">
              <Calendar className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#264143]" />
            </div>
            <span className="text-sm sm:text-sm md:text-base text-[#264143]">Semester-wise resources</span>
          </div>
          
          <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3">
            <div className="w-7 h-7 sm:w-7 sm:h-7 md:w-8 md:h-8 transition-all duration-200 ease-in-out hover:rotate-[-5deg] hover:scale-105 rounded-full bg-[#EDDCD9] flex items-center justify-center flex-shrink-0">
              <BookMarked className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#264143]" />
            </div>
            <span className="text-sm sm:text-sm md:text-base text-[#264143]">Subject-specific notes</span>
          </div>
        </div>
        ...
        <div className="mt-auto pt-4 sm:pt-5 md:pt-6">
          <Link 
            ...
            className="inline-flex items-center justify-center w-full py-2 sm:py-2.5 md:py-3 px-4 sm:px-4 md:px-5 bg-[#DE5499] text-white font-bold text-sm sm:text-base md:text-base rounded-md hover:bg-[#d04186] transition-colors group-hover:shadow-[0.15em_0.15em_0_#264143] sm:group-hover:shadow-[0.17em_0.17em_0_#264143] md:group-hover:shadow-[0.2em_0.2em_0_#264143]"
          >
