...
export default function AddYear() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(`Year ${yearNumber} created successfully!`);
      setYearNumber('');
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#264143]">Add New Year</h1>
        </div>
        ...
        <div className="bg-white border-[0.25em] border-[#264143] rounded-[0.6em] shadow-[0.4em_0.4em_0_#E99F4C] overflow-hidden relative">
          ...
          <div className="absolute w-[2em] h-[2em] bg-[#7BB4B1] border-[0.15em] border-[#264143] rounded-[0.3em] rotate-12 top-[-0.8em] right-[2em] z-0"></div>
            ...
            {successMessage ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <p className="mt-2 text-sm text-[#264143] opacity-70">Enter a number between 1 and 10 to represent the year number.</p>
                </div>
